          ...
          <div class = "row">
            <div class = "col-md-4 col-md-offset-4">
              ...
              <div class = "login">
                    ...
                    <?php 
                      if(!empty($_SESSION["signupSameUserNameorEmail"])){ ?>
                        <div class="error-login"> * username or email is already taken </div>
                       <?php } ?>


                    <?php 
                      if(!empty($_SESSION["signupInfo"])){ ?>
                        <div class="error-login"> * make sure to fill the complete form </div>
                       <?php } ?>


                      <?php 
                      if(!empty($_SESSION["signupPassword"])){ ?>
                        <div class="error-login"> * make sure to confirm password correctly </div>
                       <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="username" class="form-control" id="username" name ="user_name" placeholder="Name">
                      ...
                      <div class = "form-group">
                          <select class = "form-control btn-warning selectpicker" name = "security_question_one" title = "security question ">
                      ...
                      <div class = "form-group">
                          <select class = "form-control btn-warning selectpicker" data-style="btn-primary" name = "security_question_two" title = "security question ">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="con_pwd" name = "user_con_password" placeholder="Confirm Password">
                      </div>
